...
//Matrices//
////////////
  this.A = new Matrix([ [-9.5052, -127.3539], [1, 0] ]);
  this.B = new Matrix([ [1], [0] ]);
  this.C = new Matrix([ [0, 92.3196] ]);
  this.D = new Matrix([ [0] ]);
  var I = new Matrix.identity(2);
  this.z0 = new Matrix([ [0], [0]]);
  this.z1 = new Matrix([ [0], [0]]);
...
////////////
  ...
  this.tomaDato = function(callback){
	...
	fs.appendFile(this.fileName, this.parseData, function (err) {
        ...
        this.toGraph = {point : medPercent , pointE : this.m};
        this.timeSend = 0;
	this.parseData = "";
            callback();
      }
